...
export const CHARMS = {
  ...
  // The third act: found on the moon, and won from its gatekeepers and warlords.
  tideglass: { name: 'Tideglass', desc: 'Stamina returns fifteen percent faster, and Moondew heals a fifth more.', color: '#eef2ff', fx: [['kiRegen', 15], ['moondew', 20]] },
  geodeheart: { name: 'Geode Heart', desc: 'Strikes break stamina a fifth faster.', color: '#8ff0ff', fx: [['ki', 20]] },
  lilyseal: { name: 'Stone Lily Seal', desc: 'Sixty more health, and blows land five percent lighter.', color: '#d8c8ff', fx: [['hp', 60], ['ward', 5]] },
  starlessring: { name: 'Starless Ring', desc: 'Below a third of your health, strikes hit a fifth harder.', color: '#b08aff', fx: [['dmgLow', 20]] },
  orrerykey: { name: 'Orrery Key', desc: 'Twenty percent more Faelight, and ten percent more Glimmer.', color: '#ffd890', fx: [['anima', 20], ['glimmer', 10]] },
  oriellamp: { name: "Oriel's Lamp", desc: 'Deflects give back twenty stamina, and dashes cost a tenth less.', color: '#fff0c8', trophy: true, fx: [['deflect', 20], ['dash', 10]] },
  shellheart: { name: "Gloam's Shell-Heart", desc: 'Eighty more health, and blocked blows cost fifteen percent less.', color: '#e8e4d8', trophy: true, fx: [['hp', 80], ['guard', 15]] },
  tessalywheel: { name: "Tessaly's Wheel", desc: 'Heavies and finishers hit fifteen percent harder, and chill builds half as fast.', color: '#8ff0ff', trophy: true, fx: [['heavy', 15], ['chillRes', 50]] },
  mothwing: { name: "Nyx's Wing", desc: 'Strikes from behind hit a fifth harder, and dashes cost fifteen percent less.', color: '#f0d8ff', trophy: true, fx: [['back', 20], ['dash', 15]] },
  corvinoath: { name: "Corvin's Oath", desc: 'Executions hit a quarter harder, and posture breaks an eighth faster.', color: '#d8c8ff', trophy: true, fx: [['exec', 25], ['ki', 12]] },
  hollowcrown: { name: 'The Hollow Crowns', desc: 'Twelve percent more damage, and forty more health.', color: '#ffe0a0', trophy: true, fx: [['dmg', 12], ['hp', 40]] },
  vespereye: { name: "Vesper's Eye", desc: 'Pause combos hit a fifth harder, and Deflects give back fifteen stamina.', color: '#c8a8ff', trophy: true, fx: [['pause', 20], ['deflect', 15]] },
  houndfang: { name: "Nightmaw's Fang", desc: 'One strike in seven opens a bleeding wound, and strikes at full health hit a tenth harder.', color: '#b07aff', trophy: true, fx: [['bleed', 14], ['dmgFull', 10]] },
  selenechain: { name: "Selene's Chain", desc: 'Moondew heals forty percent more, and Faelight fills fifteen percent faster.', color: '#ffffff', trophy: true, fx: [['moondew', 40], ['anima', 15]] },
  firstlight: { name: 'First Light', desc: 'Fifteen percent more damage, and fifteen percent more Faelight.', color: '#ffd890', trophy: true, fx: [['dmg', 15], ['anima', 15]] },
};
